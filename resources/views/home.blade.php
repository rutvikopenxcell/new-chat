...
<body class="antialiased">
    ...
    <main>
        ...
        <div id="type-box">
            ...
            <a><button id="send"><svg viewBox="0 0 512 512" width="20" title="location-arrow">
    ...
    <script src="http://192.168.2.73:3000/socket.io/socket.io.js"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
    <script>
        var socket = io.connect('http://192.168.2.73:3000');
